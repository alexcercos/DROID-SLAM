...
if __name__ == '__main__':
    ...
    pos = traj_ref.positions_xyz[0]
    last_pos = traj_ref.positions_xyz[-1]
    loop_dist = math.sqrt((pos[0]-last_pos[0])**2+(pos[1]-last_pos[1])**2+(pos[2]-last_pos[2])**2)
